...
export const ShipSynopItem = (props) => {
    ...
    const submitItem = () => {
        return {
            ...
            CM: state.cm,
            cs: state.cs,
            dataObservacao: state.dataObservacao,
            dd: state.dd,
            ddddddd: state.ddddddd,
            di: state.di,
            ds: state.ds,
            dw1dw1: state.dw1dw1,
            dw2dw2: state.dw2dw2,
            ...
            nbnbnb: state.nbnbnb,
            nh: state.nh,
            observador: state.observador,
            p0p0p0p0: state.p0p0p0p0,
            p24p24p24: state.p24p24p24,
            ppp: state.ppp,
            pppp: state.pppp,
            pw1pw1: state.pw1pw1,
            pw2pw2: state.pw2pw2,
